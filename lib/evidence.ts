...
const EVIDENCE_06A_SVG = cctvSvg({
  ...
  cam: "04",
  scene: `
    <rect x="80" y="80" width="640" height="320" fill="#131B2E"/>
    <!-- fluorescent run overhead -->
    <ellipse cx="400" cy="118" rx="250" ry="30" fill="#222F57"/>
    <rect x="300" y="88" width="200" height="7" rx="3" fill="#42549A"/>
    <rect x="80" y="150" width="640" height="152" fill="#172140"/>
    <text x="400" y="142" text-anchor="middle" font-family="monospace" font-size="10" fill="#5468BE" letter-spacing="4">FLORIDA CORNER STORE — AISLE 04</text>

    <!-- floor, tiled -->
    <rect x="80" y="302" width="640" height="98" fill="#1C2848"/>
    <g stroke="#2D3C6E" stroke-width="1" opacity="0.7">
    ...
    <rect x="94" y="166" width="152" height="142" fill="#0F1628" stroke="#2A3866"/>
    <g fill="#303F74">
    ...
    <rect x="544" y="166" width="152" height="142" fill="#0F1628" stroke="#2A3866"/>
    <g fill="#303F74">
    ...
    <g>
      <rect x="552" y="164" width="15" height="16" fill="#3E4047"/><rect x="571" y="167" width="13" height="13" fill="#5468BE"/><rect x="588" y="162" width="16" height="18" fill="#35373D"/><rect x="608" y="166" width="14" height="14" fill="#45474E"/><rect x="626" y="163" width="15" height="17" fill="#42549A"/><rect x="645" y="167" width="13" height="13" fill="#4C4E55"/><rect x="662" y="164" width="14" height="16" fill="#373940"/>
      ...
      <rect x="552" y="228" width="15" height="16" fill="#3D3F46"/><rect x="571" y="231" width="13" height="13" fill="#5468BE"/><rect x="588" y="226" width="16" height="18" fill="#34363C"/><rect x="608" y="230" width="14" height="14" fill="#484A51"/><rect x="626" y="227" width="15" height="17" fill="#3C3E45"/><rect x="645" y="231" width="13" height="13" fill="#4D4F56"/><rect x="662" y="228" width="14" height="16" fill="#393B42"/>
      <rect x="552" y="260" width="14" height="16" fill="#4B4D54"/><rect x="570" y="263" width="15" height="13" fill="#35373D"/><rect x="589" y="258" width="15" height="18" fill="#4B5EAC"/><rect x="608" y="262" width="13" height="14" fill="#4E5057"/><rect x="625" y="259" width="16" height="17" fill="#42549A"/><rect x="645" y="263" width="14" height="13" fill="#45474E"/><rect x="663" y="260" width="13" height="16" fill="#3D3F46"/>
    </g>

    <!-- checkout counter with register -->
    <rect x="286" y="286" width="228" height="26" fill="#24315C"/>
    <rect x="286" y="312" width="228" height="40" fill="#161F38"/>
    <rect x="286" y="286" width="228" height="3" fill="#42549A"/>
    <rect x="438" y="266" width="52" height="22" rx="2" fill="#303F74" stroke="#4D60B0"/>
    <rect x="444" y="271" width="40" height="10" fill="#172140"/>

    <!-- storefront glass, right: a car waiting at the kerb -->
    <rect x="512" y="296" width="196" height="104" fill="#101A32"/>
    <path d="M536 350 L688 350 L700 374 L524 374 Z" fill="#1B2748"/>
    <rect x="548" y="318" width="128" height="34" rx="5" fill="#141D33" stroke="#303F74"/>
    <rect x="512" y="296" width="196" height="104" fill="none" stroke="#42549A" stroke-width="2"/>
    ...
    <path d="M340 400 Q352 292 400 288 Q448 292 460 400 Z" fill="#1F2C52"/>
    <path d="M348 400 Q356 300 400 296 Q444 300 452 400 Z" fill="#2B3968"/>
    ...
    <path d="M382 282 L400 300 L418 282" stroke="#42549A" stroke-width="1.5" fill="none"/>
...
const EVIDENCE_06B_SVG = cctvSvg({
  ...
  cam: "07",
  scene: `
    <rect x="80" y="80" width="640" height="320" fill="#0E1424"/>
    <!-- motel facade -->
    <rect x="80" y="96" width="640" height="188" fill="#18233F"/>
    <rect x="80" y="278" width="640" height="8" fill="#222F57"/>
    <text x="400" y="134" text-anchor="middle" font-family="monospace" font-size="10" fill="#5468BE" letter-spacing="4">VICE MOTEL — PARKING BAY 07</text>
    <g>
      <rect x="120" y="160" width="66" height="74" fill="#0D1426" stroke="#303F74"/>
      <rect x="216" y="160" width="66" height="74" fill="#3A3428" stroke="#303F74"/>
      <rect x="312" y="160" width="66" height="74" fill="#0D1426" stroke="#303F74"/>
      <rect x="408" y="160" width="66" height="74" fill="#0D1426" stroke="#303F74"/>
      <rect x="504" y="160" width="66" height="74" fill="#3A3428" stroke="#303F74"/>
      <rect x="600" y="160" width="66" height="74" fill="#0D1426" stroke="#303F74"/>
    </g>
    <rect x="188" y="168" width="112" height="66" fill="#141C30"/>
    <!-- parked car: profile, facing away -->

    <!-- asphalt with bay markings -->
    <rect x="80" y="286" width="640" height="114" fill="#151E36"/>
    <g stroke="#2D3C6E" stroke-width="2" opacity="0.8">
      <path d="M140 286 V400"/><path d="M660 286 V400"/>
    </g>
    <path d="M240 286 V400" stroke="#2D3C6E" stroke-width="1" opacity="0.4" stroke-dasharray="8 10"/>

    <!-- the car, seen from behind -->
    <path d="M250 306 Q262 250 340 240 L470 240 Q548 250 560 306 Z" fill="#1F2C52"/>
    <rect x="242" y="300" width="326" height="62" rx="6" fill="#192542"/>
    <path d="M256 308 Q268 258 342 250 L468 250 Q542 258 554 308 Z" fill="#2B3968"/>
    <!-- rear light clusters -->
    ...
    <rect x="242" y="352" width="326" height="16" fill="#121A30"/>
    <rect x="386" y="344" width="38" height="10" fill="#0C1222"/>
    <rect x="346" y="290" width="118" height="26" rx="2" fill="#0C1222"/>
    ...
    <!-- wheels -->
    <rect x="252" y="358" width="56" height="34" rx="4" fill="#0C1222"/>
    <rect x="502" y="358" width="56" height="34" rx="4" fill="#0C1222"/>
    <!-- shadow under the car -->
    <ellipse cx="405" cy="394" rx="176" ry="10" fill="#080D1A" opacity="0.65"/>

    <!-- occupant still in the rear seat -->
    <path d="M380 268 Q383 240 405 238 Q427 240 430 268 Z" fill="#1C2848"/>
...
const EVIDENCE_06C_SVG = cctvSvg({
  ...
  scene: `
    ...
    <ellipse cx="300" cy="196" rx="230" ry="118" fill="#232F58" opacity="0.85"/>
    <text x="400" y="128" text-anchor="middle" font-family="monospace" font-size="10" fill="#5468BE" letter-spacing="4">VICE MOTEL — FRONT DESK</text>

    <!-- desk surface -->
    <rect x="120" y="176" width="560" height="200" fill="#1A2440"/>
    ...
    <rect x="476" y="196" width="118" height="40" fill="#0C1222"/>
